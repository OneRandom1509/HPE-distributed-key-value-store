...
typedef allocator<std::pair<const int, MyShmString>,
                  managed_shared_memory::segment_manager>
  MemoryMapAllocator;
typedef boost::unordered_map<int, MyShmString, boost::hash<int>,
                             std::equal_to<int>, MemoryMapAllocator>
  MemoryHashMap;

// Persistent storage type definitions
typedef allocator<char, managed_mapped_file::segment_manager>
  MappedCharAllocator;
typedef basic_string<char, std::char_traits<char>, MappedCharAllocator>
  MappedShmString;
typedef allocator<std::pair<const int, MappedShmString>,
                  managed_mapped_file::segment_manager>
  MappedMapAllocator;
typedef boost::unordered_map<int, MappedShmString, boost::hash<int>,
                             std::equal_to<int>, MappedMapAllocator>
  MappedHashMap;
